...
$(function () {
  ...
  if (emailUserList.find('li').length) {
    emailUserList.find('li').on('click', function (e) {
      ...
      $("#append_emails_body").html('<div class="d-flex justify-content-center"> <div class="spinner-border" role="status" style="width: 100px;height: 100px;margin-top: 50px;margin-bottom: 100px;"><span class="visually-hidden">Loading...</span></div></div>');
      $.ajax({
        url: route,
        method: "GET",
        beforeSend: function () {
        ...
        success: function (res) {
          if (res.success == true && res.data) {
            $("#append_emails_body").html(res.data)
          }
