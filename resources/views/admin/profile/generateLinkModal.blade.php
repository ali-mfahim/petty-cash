<div class="modal fade" id="generateFormLinkModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form id="createUserForm" class="row gy-1 pt-75" onsubmit="return false">
                    ...
                    <div class="col-md-10 col-md-6">
                        ...
                        <input type="text" id="form_link" name="form_link" class="form-control" placeholder="-------" value="" data-msg="" readonly />
                        <div id="form_link_error" class="text-danger"></div>
                    </div>
                    <div class="col-md-2  ">
                        <button type="button" class="btn btn-primary generate-link-button" style="margin-top:20px">Generate</button>
                    </div>
