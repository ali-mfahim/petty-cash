                    ...
                    <div class="card-body">
                        <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column" style="margin-top: 50px;">
                                ...
                                <img src="{{ asset(config('project.upload_path.users').$model->image ?? null) }}" alt="{{ getUserName($record) ?? null }}" class="w-100" />
                                @else
            ...
            <div class="col-md-9">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="navs-edit-account" role="tabpanel">
                        <div class="card">
                            <div class="card-body">
                                <form id="edit-profile" class="pt-0 fv-plugins-bootstrap5 fv-plugins-framework" action="" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="first_name">First Name <span class="text-danger">*</span> </label>
                                            <input type="text" class="form-control" id="first_name" placeholder="First Name" value="{{$model->first_name ?? ''}}" name="first_name">
                                            <span id="first_name_error" class="text-danger error"></span>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="last_name">Last Name</label>
                                            <input type="text" class="form-control" id="last_name" placeholder="Last Name" value="{{$model->last_name ?? ''}}" name="last_name">
                                            <span id="last_name_error" class="text-danger error"></span>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="email">Email <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control" id="email" placeholder="Email" value="{{$model->email ?? ''}}" name="email">
                                            <span id="email_error" class="text-danger error"></span>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="address">Address</label>
                                            <input type="text" class="form-control" id="address" placeholder="Address" value="{{$model->address ?? ''}}" name="address">
                                            <span id="address_error" class="text-danger error"></span>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="phone_number">Phone Number</label>
                                            <input type="text" class="form-control" id="phone_number" placeholder="Phone Number" value="{{$model->phone ?? ''}}" name="phone_number">
                                            <span id="phone_number_error" class="text-danger error"></span>
                                        </div>
                                        <div class="col-12 order-2 order-xl-0">
                                            <button id="updateButton" type="submit" class="btn btn-primary me-2">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
