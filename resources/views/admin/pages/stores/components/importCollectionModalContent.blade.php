                    ...
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                        ...
                        <span>
                            <div class="form-check me-3 me-lg-5">
                                <input class="form-check-input storeImportCollectionCheckbox " name="storeRadio" type="checkbox" value="{{$value->id}}" id="storeRadio_{{$index}}" @if($value->id == $store->id) disabled @endif />
                            </div>
                        </span>
                    </span>
                </label>
